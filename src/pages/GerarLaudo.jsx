...
//             <input
//               type="text"
//               placeholder="Paciente selecionado"
//               value={nomePaciente}
//               disabled
...
//             accept="image/*"
//             onChange={handleImagem}
//             className="mb-4  rounded-md  cursor-pointer px-3 py-2 bg-linear-to-r from-slate-100 to-slate-200 hover:from-primary-200 hover:to-primary-400"
//           />
